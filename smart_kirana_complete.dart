            ...
            GridView.count(
              ...
              children: [
                ...
                _buildFeatureCard(
                  ...
                  () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const CloudFunctionsScreen()),
                  ),
                ),
                _buildFeatureCard(
                  context,
                  ...
                  () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const RealtimeSyncScreen()),
                  ),
                ),
              ],
            ),
...
class _MapsScreenState extends State<MapsScreen> {
  ...
  void _addInitialMarkers() {
    final locations = [
      {'name': 'San Francisco', 'lat': 37.7749, 'lng': -122.4194, 'color': Colors.red},
      {'name': 'New York', 'lat': 40.7580, 'lng': -73.9855, 'color': Colors.blue},
      {'name': 'London', 'lat': 51.5074, 'lng': -0.1278, 'color': Colors.green},
    ];
      ...
      _markers.add(
        Marker(
          ...
          icon: BitmapDescriptor.defaultMarkerWithHue(
            _getColorHue(location['color']! as Color),
          ),
        ),
      );
    }
